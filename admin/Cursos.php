    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="btn-group float-end">
                    <button class="btn btn-sm btn-success" type="button" data-bs-toggle="modal" data-bs-target="#registerModalCourse"><i class="fa-solid fa-plus"></i> Nuevo Curso</button>
                </div>
                <h5>Cursos/List</h5>
...
<div class="row">
    <div class="col">
        <div class="table-responsive">
            <table class="table" id="CourseTabla" data-height="720" data-show-export="true" data-show-fullscreen="true" data-unique-id="count">
                <thead class="table-dark">
                    <tr>
                        <th data-field="count" data-sortable="true">#</th>
                        <th data-field="cataloge" data-sortable="true">Curso</th>
                        <th data-field="professor" data-sortable="true">Profesor</th>
                        <th data-field="type" data-sortable="true">Tipo</th>
                        <th data-field="status" data-sortable="true">Estado</th>
                        <th data-field="schedule" data-sortable="true">Horario</th>
...
<div class="modal fade" id="successEditModalAula" tabindex="-1" aria-labelledby="successEditModalAulaLabel" aria-hidden="true">
    ...
    <script src="../admin/models/CursosModel.js"></script>
    <script src="../admin/controllers/CursosController.js"></script>
